...
public class SocketControllersGroup implements SocketHandler{
    private static final Logger log = Logger.getLogger(SocketControllersGroup.class);
    ...
    public SocketControllersGroup addController(SocketController controller) {
        ...
        log.info("SocketServer mapped controller [" + controller.getClass().getName() + "]");
        return this;
    }
    ...
    @Override
    public void handle(SocketRoutingItem item, SocketMsg request, List<SocketResponse> responses) throws SocketException {
